<template>
  <div class="m-4">
    <CollapseContainer :title="t('routes.logic.staff.payments.create.title')">
      <BasicForm
        :labelWidth="100"
        :schemas="schemas"
...
<script lang="ts">
  ...
  import {createStaffPayment} from "/@/api/logic/staffPayment/requests";
    ...
    setup() {
      ...
      return {
        ...
        handleSubmit: async (values: any) => {
          ...
          try {
            await createStaffPayment(values);
