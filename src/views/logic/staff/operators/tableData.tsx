...
import {getClientFilterSchema} from "/@/views/logic/staff/common/table";
...
export function getColumns(): BasicColumn[] {
  ...
  return [
    ...
    {
      title: t('routes.logic.staff.operators.fields.name'),
      dataIndex: 'name',
      sorter: true,
      width: 160,
    },
    ...
    schemas: [
      {
        ...
        component: 'Input',
        componentProps: {
          placeholder: t('routes.logic.staff.operators.fields.name'),
        },
        colProps: {
          lg: 6,
          xl: 4,
