...
export const drawLogo = ({ canvas, logo }: RenderQrCodeParams) => {
  ...
  // __Some-New-Token__image__Some-New-Token__
  const drawLogoWithImage = (image: CanvasImageSource) => {
    ctx.drawImage(image, logoXY, logoXY, logoWidth, logoWidth);
  };

  // __Some-New-Token__canvas__Some-New-Token__
  ...
  // __Some-New-Token__ logo__Some-New-Token__ canvas__Some-New-Token__
  return new Promise((resolve) => {
    image.onload = () => {
...
// copy__Some-New-Token__，__Some-New-Token__
